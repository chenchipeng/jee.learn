 ...
 * 
 * <p>Title: Condition</p>
 * <p>Description: 条件封装类，用于封装查询条件 {@link IEntityDao}</p>
...
public class Condition implements Iterable<Condition.Paramerter>, Serializable {
    ...
    public enum Operator {
        EQ, NE, LIKE, GT, LT, GE, LE, ISNULL, ISNOTNULL, ISEMPTY, ISNOTEMPTY, IN, NOTIN, OR, EQEX, NEEX
    }

    /**
     * 
     * <p>Title: Paramerter</p>
     * <p>Description: 内部参数类，包含键名、值及操作三元素信息 {@link Condition}</p>
     * <p>Copyright: Copyright (c) 2013 ITDCL  All right reserved.</p>
     * <p>Company: ITDCL</p>
     * @author yjf
     * @version 1.0
     ...
     * 修改记录:
     * 下面填写修改的内容以及修改的日期
     * 1.2013-9-6 下午5:13:04  yjf    new
     */
    public static class Paramerter implements Serializable {
        private static final long serialVersionUID = 6947887931957854726L;
