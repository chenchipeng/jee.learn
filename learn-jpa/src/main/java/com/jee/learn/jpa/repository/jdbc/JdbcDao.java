 ...
 * @version 1.0
 *
 *          修改记录: 下面填写修改的内容以及修改的日期 1.2013-9-10 上午10:56:25 yjf new
 */
public interface JdbcDao {
    ...
    /**
     * 带预编译参数检索一列并映射成该列所对应的类型对象(基本数据类型)
     * 
     * @param sql
     * @param clazz
     * @param args
    ...
    /**
     * 带预编译参数检索一列的一条记录并映射成该记录所对应的类型对象(基本数据类型)
     * 
     * @param sql
     * @param clazz
     * @param args
     ...
     * @return
     */
    List<Map<String, Object>> queryForList(String sql, int offset, int limit);
     ...
     * @return
     */
    List<Map<String, Object>> queryForList(String sql, int offset, int limit, Object... args);
