package com.jee.learn.interfaces.support.jpa.spec;
 ...
 * </pre>
 * 
 * 参考：https://blog.csdn.net/u012706811/article/details/53218102
 * 
 * @author Niu Li
 * @date 2016/11/17
 */
public class QueryParams<T> implements Specification<T> {
    ...
    private static final long serialVersionUID = -7754008089362922272L;
