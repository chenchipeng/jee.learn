package com.jee.learn.interfaces.support.jpa.dao.service;
...
import com.jee.learn.interfaces.support.jpa.dao.Sort.Direction;
...
public abstract class EntityServiceImpl<T, ID extends Serializable> implements EntityService<T, ID> {
    ...
    public void saveOrUpdate(T entity) {
        ...
        Object primaryKey = ReflectUtils.invokeGetter(entity, EntityDao.PRIMARY_KEY_NAME);
    ...
    protected Sort parseSort(String orderBy) {
        Sort sort = new Sort(Direction.DESC, EntityDao.PRIMARY_KEY_NAME);
