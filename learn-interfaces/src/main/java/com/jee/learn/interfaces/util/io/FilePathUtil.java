...
import com.jee.learn.interfaces.util.base.Platforms;
import com.jee.learn.interfaces.util.text.CharUtil;
...
public class FilePathUtil {
    ...
    public static String concat(String baseName, String... appendName) {
        ...
        if (CharUtil.endWith(baseName, Platforms.FILE_PATH_SEPARATOR_CHAR)) {
    ...
    public static String getParentPath(String path) {
        ...
        parentPath = CharUtil.removeEnd(parentPath, Platforms.FILE_PATH_SEPARATOR_CHAR);
