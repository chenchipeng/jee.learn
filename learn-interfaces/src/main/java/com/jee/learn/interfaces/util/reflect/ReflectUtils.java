 ...
 */
package com.jee.learn.interfaces.util.reflect;
            ...
            for (int i = 0; i < cs.length; i++) {
                if (args[i] != null && !args[i].getClass().equals(cs[i])) {
                    if (cs[i] == String.class) {
                        args[i] = toString(args[i], StringUtils.EMPTY);
                        ...
                        if (args[i] instanceof String) {
                            args[i] = DateUtils.parseDate(toString(args[i], StringUtils.EMPTY), "yyyy-MM-dd HH:mm:ss");
                        }
                    }
                }
            }
