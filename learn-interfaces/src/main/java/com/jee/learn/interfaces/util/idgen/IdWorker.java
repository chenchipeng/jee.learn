...
/**
 * 来自于twitter项目snowflake的id产生方案，全局唯一，时间有序。 64位ID (42(毫秒)+5(机器ID)+5(业务编码)+12(重复累加)) https://github.com/twitter/snowflake/blob/scala_28/src/main/
...
public class IdWorker {
     ...
     * 初始化
     * 
     * @param workerId 机器ID, 大于0且小于{@link IdWorker#maxWorkerId}, 等于-1将随机产生
     * @param datacenterId 业务编码, 大于0且小于{@link IdWorker#maxDatacenterId}, 等于-1将随机产生
     */
