 ...
 */
package com.jee.learn.interfaces.util.mapper;
...
public class JsonMapper extends ObjectMapper {
    ...
    /**
     * 反序列化复杂Collection如List<Bean>, 先使用函数createCollectionType构造类型,然后调用本函数.<br/>
     * 构造泛型的Collection Type如: ArrayList<MyBean>,<br/>
    ...
    public static <T> T fromJson(String jsonString, Class<?> collectionClass, Class<?>... elementClasses) {
        JavaType javaType = JsonMapper.getInstance().createCollectionType(collectionClass, elementClasses);
        return (T) JsonMapper.getInstance().fromJsonString(jsonString, javaType);
    }
