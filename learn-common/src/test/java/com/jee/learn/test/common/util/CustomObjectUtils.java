package com.jee.learn.test.common.util;
...
/**
 * Created by lonecloud on 17/3/12.<br/>
 * 用于对Object进行解析并且转换成Map键值对的形式<br/>
 * 参考:https://www.cnblogs.com/lonecloud/p/6537586.html
 *
 * @author lonecloud
 * @version 1.0
 */
